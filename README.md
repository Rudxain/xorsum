...
This is meant for the development of the experimental [lib.rs](src/lib.rs), because any change to it would be a breaking change (the API is **very unstable**, currently). This branch allows us to edit the lib without the need to increment the Major-semver-number.
